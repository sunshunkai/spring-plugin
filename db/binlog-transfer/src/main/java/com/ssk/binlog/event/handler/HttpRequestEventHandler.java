...
public class HttpRequestEventHandler implements IEventHandler {
    ...
    @Override
    public void process(EventEntity eventEntity) throws BinlogException {
        post(eventEntity.getJsonFormatData());
    }

    private void post(String param) throws BinlogException {
            ...
            try {
                ...
                if (httpCallback != null) {
                    ...
                    if (response.getStatusLine().getStatusCode() != 200) {
                        ...
                        throw new BinlogException("http request failed.code:" + response.getStatusLine().getStatusCode());
                    }
