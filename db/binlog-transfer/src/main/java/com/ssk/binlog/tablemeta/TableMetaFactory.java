package com.ssk.binlog.tablemeta;
...
public class TableMetaFactory {
    ...
    public TableMetaEntity getTableMetaEntity(Long tableId, String dbName, String tableName) throws BinlogException {
        ...
        try {
            ...
            throw new BinlogException(e.getCause());
        } finally {
            if (connection != null) {
                try {
                    connection.close();
